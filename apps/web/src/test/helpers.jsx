 ...
 *
 * AuthProvider re-reads the session on mount via api.me, so that is stubbed
 * here rather than in every test: it resolves with whatever signIn() stored,
 * or 401s when signed out. A test that cares about session refresh can
 * still override the spy afterwards.
 */
